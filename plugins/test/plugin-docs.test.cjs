...
assert.match(sierraSource, /Half Gap/);
assert.doesNotMatch(sierraSource, /"Mid Gap"/);
assert.match(sierraSource, /LINESTYLE_DASH/);
...
assert.match(quantowerSource, /Levels\/stats refresh milliseconds/);
assert.match(quantowerSource, /RefreshMilliseconds = 1000/);
assert.match(quantowerSource, /IsHalfGap/);
assert.match(quantowerSource, /Half Gap/);
assert.match(quantowerSource, /DashStyle\.Dash/);
...
assert.match(quantowerProject, /AppendTargetFrameworkToOutputPath/);
assert.match(quantowerProject, /AppendRuntimeIdentifierToOutputPath/);
