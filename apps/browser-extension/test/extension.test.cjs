...
assert.match(popup, /tradingViewBundleText/);
assert.match(popup, /fetch\(`\$\{settings\.serviceUrl\}\/tradingview`\)/);
assert.match(popup, /\/tradingview\/\$\{selectedSymbol\(\)\}\?format=json/);
assert.match(popup, /format=json/);
assert.match(popup, /\/diagnostics/);
assert.match(popup, /\/plugins/);
assert.match(popup, /copyTradingView/);
assert.match(popup, /tradingViewFallbackBundleText/);
assert.match(popup, /futuresSymbols/);
assert.match(popup, /normalizeDisplaySymbol/);
