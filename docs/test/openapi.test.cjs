...
for (const schema of ['Snapshot', 'SymbolSnapshot', 'SymbolSummary', 'PluginManifest', 'PluginEntry', 'Level', 'TradingViewExport', 'TradingViewBundleExport', 'TradingViewLevelRow', 'CapturePayload', 'Diagnostics', 'DiagnosticCheck']) {
